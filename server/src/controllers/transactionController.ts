...
// Iniciate connection to Stripe on payment card checkout
// PCI DSS safety
export const createStripePaymentIntent = async (
  ...
  try {
    ...
    res.json({ message: "", data: { clientSecret: paymentIntent.client_secret, }, }); // no message to show in notifications
  } catch (error) {
    res
      .status(500)
