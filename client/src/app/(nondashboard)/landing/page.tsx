...
const Landing = () => {
    const currentImage = useCarousel({ totalImages: 3 }); // hook to cycle between images
        ...
        >
            ...
            >
                <div className='landing__hero-content'>
                    ...
                    <p className='landing__description'>List of courses you can enroll in.
                        <br />
                ...
                <div className="landing__hero-images">
                    {["/hero1.jpg", "/hero2.jpg", "/hero3.jpg"].map((src, index) => (
                        <Image
                            ...
                            // optimizing image's resolutions based on screen sizes
